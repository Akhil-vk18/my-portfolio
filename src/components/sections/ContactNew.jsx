...
const ContactNew = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const mailtoLink = `mailto:connectwithakhilsanthosh@gmail.com?subject=Message from ${encodeURIComponent(formData.name)}&body=${encodeURIComponent(formData.message)}`;
